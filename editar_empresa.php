    ...
    <form id="editar_empresa" action="" method="POST">
        ...
        <div class="row">
            <div class="col">
                ...
                <input class="form-control" type="text" name="email_empresa"  value='<?php echo $empresa["email_empresa"];?>'>
            </div>

            <div class="col">
                <label for="telefono_empresa">Teléfono de la empresa</label>
                <input class="form-control" type="text" name="telefono_empresa"  value='<?php echo $empresa["telefono_empresa"];?>'>
            </div>
        </div>
