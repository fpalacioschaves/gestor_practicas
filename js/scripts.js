...
function filtrar_por_asociar(){
    var ajax_url = "./filtrar_por_asociar.php";
...
function filtrar_asociado(){
    var ajax_url = "./filtrar_asociado.php";
...
function filtrar_finalizado(){
    var ajax_url = "./filtrar_finalizado.php";
...
function favorita(id_empresa){
     var ajax_url = "./favorita.php";
    ...
    ajax_request.onreadystatechange = function() {
        ...
        if (ajax_request.readyState == 4 ) {
            ...
            document.getElementById("favorita_" + id_empresa ).innerHTML = response;
